										 ...
										 <h1>Voyages</h1>
															<form action="/search" method="GET" class="card card-sm">
																	<div class="card-body row no-gutters align-items-center">
																			...
																			<!--end of col-->
																			<div class="col-md-10">
																					<input class="form-control form-control-lg form-control-borderless" style="background:white;" type="search" name="search" placeholder="Search topics or keywords">
																			</div>
																			<!--end of col-->
																			<div class="col-auto">
						...
						<div class="row">
							<div class="wrap-division">
								...
								<div class="col-md-6 col-sm-6 animate-box">
									<div class="tour">	
											<a href="{{route('sejour', ['id' => $voyage->id])}}" class="tour-entry animate-box">
												<div class="tour-img" style="background-image: url({{$voyage->photo}});">
												</div>
												<span class="desc">
													<p class="star"><span><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i><i class="icon-star-full"></i></span> 545 Reviews</p>
													<h2>{{$voyage->libelle}}</h2>
													<span class="city">{{$voyage->pays}}</span>
													<span class="price">{{$voyage->cout}}</span>
												</span>
											</a>
											<div style="display:flex;">
												@auth
											<button style="margin-right:10px; background:black; padding:10px;border:none; "><a href="/admin/voyages/{{$voyage->id}}/edit">Modifier</a></button>
											<form action="/admin/voyages/{{$voyage->id}}" method="POST">
													@method('DELETE')
													@csrf
